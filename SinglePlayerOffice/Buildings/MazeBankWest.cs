        ...
        public MazeBankWest() {
            try {
                ...
                garageEntrance = new GarageEntrance {
                    Trigger = new Vector3(-1361.918f, -472.036f, 31.233f),
                    Spawn = new Vector3(-1361.918f, -472.036f, 31.233f),
                    Heading = 100f,
                    CamPos = new Vector3(-1358.206f, -473.482f, 32.596f),
                    CamRot = new Vector3(-10f, 0f, 65f),
                    CamFOV = 60f
                };
                office = new Office {
