...
namespace SinglePlayerOffice.Interactions {
    class BossChairInteraction : Interaction {
        ...
        public override string RejectHelpText {
            get {
                return "Only boss can sit here";
            }
        }

        public BossChairInteraction() {
        ...
        public override void Update() {
            ...
            switch (State) {
                case 0:
                    ...
                    break;
                case 1:
                    initialPos = Function.Call<Vector3>(Hash.GET_ANIM_INITIAL_OFFSET_POSITION, "anim@amb@office@boardroom@boss@male@", "enter_b", chair.Position.X, chair.Position.Y, chair.Position.Z, chair.Rotation.X, chair.Rotation.Y, chair.Rotation.Z, 0, 2);
                    initialRot = Function.Call<Vector3>(Hash.GET_ANIM_INITIAL_OFFSET_ROTATION, "anim@amb@office@boardroom@boss@male@", "enter_b", chair.Position.X, chair.Position.Y, chair.Position.Z, chair.Rotation.X, chair.Rotation.Y, chair.Rotation.Z, 0, 2);
                ...
                case 4:
                    ...
                    Function.Call(Hash.TASK_SYNCHRONIZED_SCENE, Game.Player.Character, syncSceneHandle, "anim@amb@office@boardroom@boss@male@", idleAnims[rnd], 4f, -1.5f, 13, 16, 1148846080, 0);
                    Function.Call(Hash.PLAY_SYNCHRONIZED_ENTITY_ANIM, chair, syncSceneHandle, chairIdleAnims[rnd], "anim@amb@office@boardroom@boss@male@", 4f, -4f, 32781, 1000f);
                    State = 3;
                    break;
                case 5:
                    ...
                    Function.Call(Hash.PLAY_SYNCHRONIZED_ENTITY_ANIM, chair, syncSceneHandle, "exit_b_chair", "anim@amb@office@boardroom@boss@male@", 4f, -4f, 13, 1000f);
                    State = 6;
                    break;
                case 6:
                    if (Function.Call<float>(Hash.GET_SYNCHRONIZED_SCENE_PHASE, syncSceneHandle) != 1f) break;
