            ...
            switch (State) {
                ...
                case 1:
                    ...
                    if (Function.Call<bool>(Hash.HAS_ANIM_DICT_LOADED, "anim@amb@office@seating@male@var_a@base@") &&
                        Function.Call<bool>(Hash.HAS_ANIM_DICT_LOADED, "anim@amb@office@seating@male@var_d@base@") &&
                        Function.Call<bool>(Hash.HAS_ANIM_DICT_LOADED, "anim@amb@office@seating@male@var_e@base@"))
                        State = 2;
                ...
                case 7:
                    ...
                    Function.Call(Hash.REMOVE_ANIM_DICT, "anim@amb@office@seating@male@var_d@base@");
                    Function.Call(Hash.REMOVE_ANIM_DICT, "anim@amb@office@seating@male@var_e@base@");
                    State = 0;
