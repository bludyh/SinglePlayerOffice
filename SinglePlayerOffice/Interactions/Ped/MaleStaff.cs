...
namespace SinglePlayerOffice.Interactions {
    class MaleStaffInteraction : Interaction, INPCInteraction {
        ...
        public override void Update() {
            switch (State) {
                case 0:
                    ...
                    break;
                case 1:
                    if (!Function.Call<bool>(Hash.IS_ENTITY_PLAYING_ANIM, chair, "anim@amb@office@boardroom@crew@male@var_b@base@", "enter_chair", 2)) {
                        ...
                        Function.Call(Hash.TASK_SYNCHRONIZED_SCENE, Ped, syncSceneHandle, "anim@amb@office@boardroom@crew@male@var_b@base@", "enter", 1.5f, -1.5f, 13, 16, 1.5f, 4);
                ...
                case 2:
                    ...
                    Function.Call(Hash.TASK_SYNCHRONIZED_SCENE, Ped, syncSceneHandle, "anim@amb@office@boardroom@crew@male@var_b@base@", "base", 4f, -1.5f, 13, 16, 1148846080, 0);
                    Function.Call(Hash.PLAY_SYNCHRONIZED_ENTITY_ANIM, chair, syncSceneHandle, "base_chair", "anim@amb@office@boardroom@crew@male@var_b@base@", 4f, -4f, 32781, 1000f);
                    State = -1;
                    break;
            }
